...
public sealed class OidcOptions
{
    ...
    {
        Shared_Library.Shared.Guard.NotNullOrEmpty(TokenEndpoint, nameof(TokenEndpoint));
        Shared_Library.Shared.Guard.NotNullOrEmpty(ClientId, nameof(ClientId));
...
public sealed class SmartOnFhirAuthService : IDisposable
{
    ...
    {
        Shared_Library.Shared.Guard.NotNullOrEmpty(fhirServerUrl, nameof(fhirServerUrl));
