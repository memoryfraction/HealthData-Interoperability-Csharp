...
[![Version](https://img.shields.io/badge/Version-1.4.3-blue.svg)](https://www.nuget.org/packages/HealthData.Interop.Fhir/1.4.3)
...
**Stability:** Current version **v1.4.3**. The project is **early-stage**; the public API may still change between minor versions. Use `HealthData.Interop.Fhir` in non-critical or proof-of-concept work until it reaches a stable 2.x line.
